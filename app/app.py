...
@app.route("/api/v1.0/map_data/<min_installation_year>")
def map_data(min_installation_year):
    # Execute Query
    df = sqlHelper.queryMapData(min_installation_year)
